...
namespace Week1CodeChallenge
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n\n TEXT STATS");
            TextStats("Umar's favorite band is Nickleback.  He wants everyone to know.  He started the Denver chapter of their fan club.");
        ...
        static void TextStats(string input)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                {
                    //not a vowel or special char, so its a consonant
                    numCons++;
                }
            }
